        ...
        {members.pi.map((m) => (
          <div key={m.id} className="bg-white dark:bg-dark-surface border border-gray-100 dark:border-gray-700 rounded-xl p-8">
            ...
            <div className="space-y-3 text-base">
              <div>
                <span className="font-semibold text-gray-700 dark:text-gray-300">{t.contact.address}:</span>
                <p className="text-text-light dark:text-gray-400 mt-1">{lt(m.department)}</p>
                <p className="text-text-light dark:text-gray-400">{lt({
                  zh: "广西南宁市大学东路100号",
              ...
              <div>
                <span className="font-semibold text-gray-700 dark:text-gray-300">{t.contact.email}:</span>
                <p className="mt-1">
              ...
              <div>
                <span className="font-semibold text-gray-700 dark:text-gray-300">{t.contact.profiles}:</span>
