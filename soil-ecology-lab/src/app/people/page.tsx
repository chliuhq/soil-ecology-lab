  ...
  return (
    <div className="container-main py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        {members.pi.map((m) => (
          <div key={m.id} className="bg-white border border-gray-100 rounded-xl p-6 hover:shadow-md transition-shadow">
            ...
            <div className="mt-4">
              ...
              <div className="space-y-1">
                {m.education.map((e, i) => (
                  <div key={i} className="text-sm text-text-light flex gap-2 flex-wrap">
                    <span className="whitespace-nowrap font-mono text-gray-500">{e.period}</span>
                    <span>
                      {(e as any).url ? (
